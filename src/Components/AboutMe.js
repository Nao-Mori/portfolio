      ...
      <div className="container-component">
        <div className="block-left">
          <div className="container-skills">
            <div className="skills">
              ...
              <div
                className="circle"
                style={{ top: '40%', left: '0%', backgroundColor: green }}
              >
                <div>CSS</div>
              </div>
              ...
              <div
                className="circle"
                style={{ top: '0%', left: '40%', backgroundColor: pink }}
              >
                <div>TypeScript</div>
              </div>
              <div
                className="circle"
                style={{ top: '13.5%', left: '67.5%', backgroundColor: green }}
              >
                <div>React.js</div>
              </div>
              ...
              <div
                className="circle"
                style={{ top: '67.5%', left: '67.5%', backgroundColor: green }}
              >
                <div>MongoDB</div>
              </div>
        ...
        <div className="block-right">
          <div className="block-right-inside">
            ...
            <h2>Nao Mori</h2>
            <h5 className="mb-3">
              I'm a Web Developer. I have serious passion for creating
              responsive web apps that are easy to use, fast and fun.
            </h5>
            <div style={{ fontSize: '20px' }}>
              ...
              <FontAwesomeIcon
                icon={faFlag}
                style={{ color: pink, marginLeft: '15px' }}
              />{' '}
              Kyoto/Japan
            </div>
          </div>
